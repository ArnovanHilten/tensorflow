...
class CustomConnected1D(Layer):
    """Custom-Connected1D layer for 1D inputs.
  ...
  """
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(CustomConnected1D, self).__init__(**kwargs)
    ...
    def get_config(self):
        ...
        base_config = super(CustomConnected1D, self).get_config()
